...
public class SmsReader extends Activity implements View.OnClickListener {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.listviewforlocalsms);
		...
		mListview.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
				...
				SmsReader.this.startActivity(lIntent);
			}
		});
		try {
			// testGetContacts();
		...
		public void onPostExecute(String Re) {
			...
			while (mCursor.moveToNext()) {
				...
				ConversationInfo conversation = new ConversationInfo(
						mRecipient, mSnippet, mNumber, mSnippetCS, mName, mThreadId);
				mConversationInfoPreviousList.add(conversation);
			}
			for (int i = 0; i < mConversationInfoPreviousList.size(); i++) {
				try {
					mConversationInfoAdapterList
							.add(mConversationInfoPreviousList.get(i).clone());
	...
	public static List<ConversationInfo> cloneConversationList() {
		...
		if(mConversationInfoPreviousList!=null) {
			for (int j = 1; j < mConversationInfoPreviousList.size(); j++) {
	...
	public static List<ConversationInfo> cloneConversationList(
			List<ConversationInfo> pInfoList) {
		List<ConversationInfo> conversationList = new ArrayList<ConversationInfo>();
		ConversationInfo info = null;
	 ...
	 * AlertDialog.Builder builder = new AlertDialog.Builder( SmsReader.this);
	 * builder.setTitle(R.string.exitdialog_title);
	 * builder.setMessage(R.string.exitdialog_content);
	 * builder.setPositiveButton(R.string.exitdialog_ok, new OnClickListener() {
	 * 
	 * @Override public void onClick(DialogInterface dialog, int which) { //
	 * TODO Auto-generated method stub SmsReader.this.finish(); } });
	...
	public void onClick(View v) {
		// TODO Auto-generated method stub
		/*
		 * if(v instanceof RelativeLayout && ((RelativeLayout)v).getId() ==
		 * R.id.mHead){ Intent intent = new Intent();
		...
		if (v.equals(mMainBack)) {
			...
			case 2:
				...
				break;
			case 3:
				intent.setClass(SmsReader.this, HolidayGridChooseSMS.class);
