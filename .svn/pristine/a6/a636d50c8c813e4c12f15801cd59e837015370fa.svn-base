...
public class ManualReplySettingActivity extends Activity implements View.OnClickListener{
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.manualreply_setting);
		Log.i(tag, "ManualReplySettingActivity");
		mInflater = (LayoutInflater)getSystemService(LAYOUT_INFLATER_SERVICE);    
		if (SetDataSource.getManualReplyFirstTimeOpenFlag(getApplicationContext())) {
			Log.i(tag, "第一次运行");

			final WindowManager mWm = (WindowManager) getSystemService(Context.WINDOW_SERVICE);
			LayoutInflater inflater = LayoutInflater.from(this);
			final View view = inflater.inflate(R.layout.manual_dialog_custom, null);
			...
			SetDataSource.setManualReplyFirstTimeOpenFlag(getApplicationContext(), false);
		} else {
			Log.i(tag, "不是第一次运行");
		}
	...
	public class ConversationAdapter extends BaseAdapter{
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			if(position == 0){
				...
				editText.setOnClickListener(ManualReplySettingActivity.this);
	...
	public void onClick(View v) {
		...
		if(v.equals(mMainBack)){
			...
			case 2:
				...
				break;
			case 3:
				intent.setClass(ManualReplySettingActivity.this,
					HolidayGridChooseSMS.class);
				intent.putExtra("phonenumber", mPhoneNumber);
				ManualReplySettingActivity.this.startActivity(intent);
				break;
			case 4:
				intent.setClass(getApplicationContext(),
					LocalSmsSendActivity.class);
