...
//						mListViews.get(arg1 % mListViews.size()), 0);
//			} catch (Exception e) {
...
//			return mListViews.get(arg1 % mListViews.size());
	...
	public void updateForSmsPackage() {
		SharedPreferences sharedPreferences = this.getSharedPreferences(
				"share", MODE_PRIVATE);
		boolean isFirstRun = sharedPreferences
				.getBoolean("isFirstaction", true);
	...
	class MyListener implements OnPageChangeListener {
		...
		public void onPageSelected(int arg0) {
			...
			// if (arg0 != i) {
			// imageViews[i]
			// .setBackgroundResource(R.drawable.main_screen_bg);
			// }
			// }
