...
public class GroupListViewNoTitle extends ListActivity implements OnClickListener {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.listviewforgroupnotitle);
		...
		public void onClick(View v) {
			...
			case R.id.btn_add:
				...
				if(MultiSelectTab.NeedSendResult){
					GroupListViewNoTitle.this.getParent().startActivityForResult(intent, 1);
				}
				else{
					GroupListViewNoTitle.this.startActivity(intent);
				}
				break;
