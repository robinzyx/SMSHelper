...
public class MultiContactListView extends Activity implements ActionBar.TabListener,
...
//		requestWindowFeature(Window.FEATURE_NO_TITLE);
		setContentView(R.layout.listviewformulticontact);
		...
		public void onPostExecute(String Re) {
			if (mListViewData.size() == 0) {
				...
				mContactAdapter = new MultiContactAdapter(
						MultiContactListView.this, mListViewData);
